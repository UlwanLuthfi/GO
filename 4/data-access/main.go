...
func main() {
	...
	// Update album
	albID, err := updateAlbum(6, Album{
		Title:  "Song of My Heart",
		Artist: "Gerry Biersch and the Band",
		Price:  69.99,
	})
...
func updateAlbum(id int64, alb Album) (int64, error) {
